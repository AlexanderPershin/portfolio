...
import django_react_dockerized from "../img/works/django_react_dockerized.png";
...
const workList = [
    ...
    {
        name: "django-react",
        link: "https://obscure-hamlet-43775.herokuapp.com/",
        picture: django_react_dockerized,
        categories: ["django", "react", "bootstrap5"],
    },
    {
        name: "django-todo",
        link: "https://immense-crag-16050.herokuapp.com/",
        picture: django_todo,
        categories: ["django", "docker", "bootstrap5"],
    },
    {
        name: "next.js app",
